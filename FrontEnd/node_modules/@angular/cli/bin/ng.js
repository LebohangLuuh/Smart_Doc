#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\DR NET SOH\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.468\\out\\buildHook\\index.js').default({tool: 'angular', checkSum: '20f91fd862ecad4310c05aVAkfVEoIDApUVwJcUAJSVlADU1AE', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/DR%20NET%20SOH/.vscode/extensions/wallabyjs.console-ninja-1.0.468/out/buildHook/index.js').then(m => m.default.default({tool: 'angular', checkSum: '20f91fd862ecad4310c05aVAkfVEoIDApUVwJcUAJSVlADU1AE', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

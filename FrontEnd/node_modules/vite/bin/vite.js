#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\DR NET SOH\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.467\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '202bb834d2e5e46083707fBUxTFgEOVQZdVgAAVQMKUFQEDlZT', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/DR%20NET%20SOH/.vscode/extensions/wallabyjs.console-ninja-1.0.467/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '202bb834d2e5e46083707fBUxTFgEOVQZdVgAAVQMKUFQEDlZT', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */

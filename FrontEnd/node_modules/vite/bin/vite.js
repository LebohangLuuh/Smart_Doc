#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('c:\\Users\\DR NET SOH\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.468\\out\\buildHook\\index.js').default({tool: 'vite', checkSum: '20265121f43fa435d0e8f7BRgEHwALBwxRVVZWVQIBUV1eUVIH', mode: 'build'}); } catch(cjsError) { try { import('file:///c:/Users/DR%20NET%20SOH/.vscode/extensions/wallabyjs.console-ninja-1.0.468/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '20265121f43fa435d0e8f7BRgEHwALBwxRVVZWVQIBUV1eUVIH', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
